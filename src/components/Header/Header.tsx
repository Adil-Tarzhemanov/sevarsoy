...
const Header: FC = () => {
    ...
    return (
        <header className={classNames(styles.header, { [styles.scrolling]: scrolling })}>
            {/*<img alt='logo'*/}
            {/*     src='/assets/home/main/logo1.png'*/}
            {/*     className={styles.logo}*/}
            {/*/>*/}
            {scrolling ? <Logo color='#5E5E5E' width={135} /> : <Logo color='white' width={135} />}
            ...
            <div className={styles.languages}>
                <button className={classNames(styles.language, styles.active)}>RU</button>
